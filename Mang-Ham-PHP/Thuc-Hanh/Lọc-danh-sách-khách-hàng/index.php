...
$customer_list = array(
    ...
    "2" =>array("name" => "Nguyễn Văn Nam", "day_of_birth" => "1983/08/21", "address" => "Bắc Giang", "profile" => "../images/1.jpg"),
    "3" =>array("name" => "Nguyễn Thái Hòa", "day_of_birth" => "1983/08/22", "address" => "Nam Định", "profile" => "../images/1.jpg"),
    "4" =>array("name" => "Trần Đăng Khoa", "day_of_birth" => "1983/08/17", "address" => "Hà Tây", "profile" => "../images/1.jpg"),
    "5" =>array("name" => "Nguyễn Đình Thi", "day_of_birth" => "1983/08/19", "address" => "Hà Nội", "profile" => "../images/1.jpg")
);
    ...
    ?>
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td><div class="profile"><img src="<?php echo $customer['profile'];?>" width='50px'/></div> </td>
            </tr>
            <?php endforeach; ?>
        </table>
</body>
