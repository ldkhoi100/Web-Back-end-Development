...
class CupController
{
    ...
    public function backupFile()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            ...
            echo "<a href='view_cup.php' class='btn btn-info'>Go to list league</a>";
            //header('Location: view_cup.php?page=backup_cup');
        }
    }
    ...
    public function edit()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            ...
            $id = $_POST['id_cup'];
            $cup = new Cup($_POST['id_cup'], $_POST['name_cup'], $_POST['image']);
