    ...
    <form action="" method='POST'>
        ...
        <table align='center'>
            <tr>
                ...
                <td><input type="text" placeholder='USD' name='invest'> USD</td>
            </tr>
            <tr>
                <td>Yearly Interest Rate:</td>
                <td><input type="text" placeholder='%' name='yearrate'> %</td>
            </tr>
            <tr>
                <td>Number of Years:</td>
                <td><input type="text" placeholder='Year' name='year'> Years</td>
            </tr>
            <tr>
                <td></td>
